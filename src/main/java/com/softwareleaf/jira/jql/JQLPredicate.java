...
/**
 * Provides an API for handling the {@literal "WAS"} JQL Operator. Note: this operator can
 * be used with the Assignee, Fix Version, Priority,  Reporter, Resolution and Status fields
 * only
 *
 * @author Jonathon Hope
 * @see <a href="https://confluence.atlassian.com/jira/advanced-searching-179442050.html#AdvancedSearching-WAS">WAS Reference</a>
 */
